...
const navieras = [
  { value: 'msc',         label: 'MSC',          logo: '/img/msc.png',         url: 'https://www.msc.com/es/track-a-shipment' },
  { value: 'maersk',      label: 'Maersk',        logo: '/img/maersk.png',       url: 'https://www.maersk.com/tracking/' },
  { value: 'cma',         label: 'CMA CGM',       logo: '/img/cma.png',          url: 'https://www.cma-cgm.com/' },
  { value: 'cosco',       label: 'COSCO',         logo: '/img/cosco.png',        url: 'https://elines.coscoshipping.com/ebusiness/cargoTracking/' },
  { value: 'hapag',       label: 'Hapag-Lloyd',   logo: '/img/hapag.png',        url: 'https://www.hapag-lloyd.com/en/online-business/track/track-by-booking-solution.html' },
  { value: 'one',         label: 'ONE',           logo: '/img/one.png',          url: 'https://ecomm.one-line.com/one-ecom/manage-shipment/cargo-tracking' },
  { value: 'oocl',        label: 'OOCL',          logo: '/img/oocl.png',         url: 'https://www.oocl.com/eng/ourservices/eservices/cargotracking/Pages/cargotracking.aspx' },
  { value: 'pil',         label: 'PIL',           logo: '/img/pil.png',          url: 'https://www.pilship.com/digital-solutions/?tab=customer&id=track-trace&label=containerTandT&module=TrackTraceBL' },
  { value: 'yangming',    label: 'Yang Ming',     logo: '/img/yangming.png',     url: 'https://www.yangming.com/en/esolution/tracking/cargo_tracking' },
  { value: 'evergreen',   label: 'Evergreen',     logo: '/img/evergreen.png',    url: 'https://ct.shipmentlink.com/servlet/TDB1_CargoTracking.do' },
  { value: 'wanhai',      label: 'Wan Hai',       logo: '/img/wanhai.png',       url: 'https://www.wanhai.com/views/cargo_track_v2/tracking_query.xhtml' },
  { value: 'zim',         label: 'ZIM',           logo: '/img/zim.png',          url: 'https://www.zim.com/tools/track-a-shipment' },
]

const aereas = [
  { value: 'latam',    label: 'LATAM Cargo',       logo: '/img/latamcargo.png',  url: 'https://www.latamcargo.com/es/rastrear' },
  { value: 'avianca',  label: 'Avianca Cargo',     logo: '/img/avianca.png',     url: 'https://www.avianca.com/co/es/informacion-de-vuelo/rastrear-carga/' },
  { value: 'iberia',   label: 'Iberia Cargo',      logo: '/img/iberia.png',      url: 'https://iberia.com' },
  { value: 'emirates', label: 'Emirates SkyCargo', logo: '/img/emirates.png',    url: 'https://www.emirates.com/mx/spanish/freight/tracking/' },
]
              ...
              >
                ...
                <div className="relative z-10 h-10 flex items-center justify-center">
                  <img
                    src={n.logo}
                    alt={n.label}
                    className="max-h-10 max-w-[80px] object-contain opacity-60 group-hover:opacity-100 transition-opacity duration-300"
