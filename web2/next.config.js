...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/embarques", destination: "https://embarques-teal.vercel.app/embarques/inicio" },
      { source: "/embarques/:path*", destination: "https://embarques-teal.vercel.app/embarques/:path*" },
