...
const EQUIPO = [
  ...
  { nombre: 'Rocio Villarroel', cargo: { es: 'Seguridad Alimentaria', en: 'Food Safety', zh: '食品安全' }, foto: '/img/rocio.png' },
  { nombre: 'Stefanie Cordova', cargo: { es: 'Administración y Finanzas', en: 'Administration and Finance', zh: '行政与财务' }, foto: '/img/stefanie.png' },
  { nombre: 'Rodrigo Castillo', cargo: { es: 'Ejecutivo comercial zona sur', en: 'Southern Zone Executive', zh: '南部区域业务顾问' }, foto: '/img/rodrigocastillo.webp' },
        ...
        <main className="flex-grow">
          <section className="relative pt-36 pb-20 md:pb-28 overflow-hidden bg-gradient-to-b from-asli-deep to-asli-dark">
            ...
            <div className="relative z-10 container mx-auto px-6 lg:px-10 max-w-4xl">
              ...
              <p data-hero-item className="text-white/65 text-lg leading-relaxed max-w-3xl">
                {tr.whoText}
              </p>
            </div>
          </section>

          <section data-page-section className="py-20 md:py-28 bg-asli-dark border-y border-white/[0.06]">
            <div className="container mx-auto px-6 lg:px-10">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div data-page-reveal className="relative">
          ...
          <section data-page-section className="py-20 md:py-28 bg-asli-secondary/25 border-b border-white/[0.06]">
            <div className="container mx-auto px-6 lg:px-10">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div data-page-reveal className="relative order-2 lg:order-1">
                ...
                <div data-page-reveal className="order-1 lg:order-2">
          ...
          <section data-page-section className="py-20 md:py-28 bg-asli-dark border-b border-white/[0.06]">
            <div className="container mx-auto px-6 lg:px-10">
              <div data-page-reveal className="mb-14">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-5">
                {EQUIPO.map((persona) => (
                  <div key={persona.nombre} data-page-reveal className="group text-center rounded-2xl p-2 transition-all duration-300 hover:bg-white/[0.03]">
          ...
          <section data-page-section className="py-8 bg-asli-deep border-t border-white/[0.06]">
            <div className="container mx-auto px-6 lg:px-10 py-16">
              <div data-page-reveal className="text-center mb-12">
          ...
          <section data-page-section className="py-20 bg-asli-dark border-y border-white/[0.06]">
            <div className="container mx-auto px-6 lg:px-10">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div data-page-reveal className="relative"><div className="relative rounded-2xl overflow-hidden aspect-video shadow-2xl shadow-black/30 ring-1 ring-white/10"><div className="absolute inset-0"><ImagePlaceholder variant="hero" src="/img/edificio.webp" className="rounded-none" /></div><div className="absolute inset-0 bg-gradient-to-t from-asli-dark/30 to-transparent" /></div></div>
              </div>
            </div>
          </section>

          <section data-page-section className="py-20 bg-asli-deep border-t border-white/[0.06]">
