...
const NuestraHistoria = () => {
  ...
  return (
    <section id="historia" className="relative overflow-hidden bg-[#F7F5F2] py-16 md:py-24">
      <div
      ...
      <div className="container-asli relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          <div ref={left.ref} style={left.style} className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <h2 className="font-display text-asli-dark text-[clamp(1.85rem,3.8vw,2.85rem)] font-bold tracking-tight text-balance mb-4">
            ...
            <p className="text-muted-strong text-base md:text-lg leading-relaxed mb-6">
            ...
            <div className="relative rounded-[20px] overflow-hidden border border-asli-dark/5 shadow-asli-med aspect-[16/10]">
              <img
              ...
              <p className="absolute bottom-4 left-4 right-4 text-white font-display font-semibold text-sm sm:text-base">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 md:gap-7">
            <blockquote
              ref={quote.ref}
              style={quote.style}
              className="border-l-4 border-asli-primary pl-5 md:pl-6 py-4 bg-white/70 rounded-r-[18px]"
            >
              <p className="font-display text-asli-dark text-xl md:text-2xl font-bold leading-snug text-balance">
            ...
            <div ref={body.ref} style={body.style} className="space-y-5 text-muted-strong text-base md:text-lg leading-relaxed">
              <p>
            ...
            <div
              ref={stats.ref}
              style={stats.style}
              className="grid grid-cols-3 gap-4 pt-6 border-t border-asli-dark/10"
            >
              {[
                { v: '2021', l: 'Fundación' },
                { v: 'Maule', l: 'Origen' },
