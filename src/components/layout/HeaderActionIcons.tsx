...
export function IconSun({ className = "", size = 15 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" className={className} aria-hidden>
      <circle cx="8" cy="8" r="3.1" {...stroke} />
      <path d="M8 1.5v1.6M8 12.9v1.6M1.5 8h1.6M12.9 8h1.6M3.2 3.2l1.1 1.1M11.7 11.7l1.1 1.1M12.8 3.2l-1.1 1.1M4.3 11.7l-1.1 1.1" {...stroke} />
    </svg>
  );
}

export function IconMoon({ className = "", size = 15 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" className={className} aria-hidden>
      <path d="M12.8 10.2A5.4 5.4 0 0 1 5.8 3.2 5.5 5.5 0 1 0 12.8 10.2Z" {...stroke} />
    </svg>
  );
}
...
/** Botón cuadrado del header claro (tema / idioma). */
