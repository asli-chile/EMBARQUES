...
export function CreadorPublicidadContent() {
  ...
  return (
    <main className="flex-1 min-h-0 overflow-auto bg-brand-blue" role="main">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_420px]">
          ...
          <section className="order-2 lg:order-1">
            <div className="lg:sticky lg:top-4">
              <div
                className="overflow-hidden rounded-xl border border-dash-border bg-black/30 shadow-2xl"
          ...
          <section className="order-1 space-y-5 lg:order-2">
                  ...
                  <button
                    ...
                    className={`rounded-lg border px-3 py-2.5 text-left text-sm font-semibold transition ${
                      pieza.plantilla === p.id
                        ? "border-dash-neon bg-dash-neon/10 text-white"
            ...
            {/* Textos */}
            <div className="space-y-3 rounded-xl border border-dash-border bg-black/20 p-4">
            ...
            {/* Banco de imágenes */}
            <div className="rounded-xl border border-dash-border bg-black/20 p-4">
                ...
                {CATEGORIAS.map((c) => (
                  <button
                    ...
                    className={`rounded-full px-3 py-1 text-xs font-semibold transition ${
                      categoria === c.id
                        ? "bg-dash-neon/20 text-white"
                        : "bg-dash-control text-dash-muted hover:text-white"
                    }`}
                  >
                    {c.nombre}
                  </button>
