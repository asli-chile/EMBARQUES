...
export const STUDIO_PRESETS: PresetDef[] = [
  ...
  },
  {
    kind: "statusBanner",
    label: "Estado",
    description: "Titular del estado con tono de severidad",
    hint: "Va primero: responde «¿qué pasa?» antes que cualquier dato.",
    defaults: {
      tone: "atencion",
      kicker: "Requiere verificación",
      title: "El buque declara un destino distinto al comprometido",
      detail: "",
    },
  },
  {
    kind: "compare",
    label: "Contraste",
    description: "Lo acordado frente a lo que cambió",
    hint: "Para cambios de puerto, fecha, tarifa o nave.",
    defaults: {
      tone: "atencion",
      leftLabel: "Comprometido",
      leftValue: "HAMBURGO",
      rightLabel: "Declara el buque",
      rightValue: "ROTTERDAM",
      arrow: "→",
    },
  },
  {
    ...
    description: "Tabla etiqueta / valor en un solo bloque",
    hint: "Una fila por línea, con formato «Etiqueta | Valor».",
    defaults: {
      strongRows: "2",
      rows: [
        "Embarque | OOLU627193-8",
        "Cliente | COPRAMAR",
        "Buque | CALLAO EXPRESS · OOCL",
        "Ruta | SAN ANTONIO → HAMBURGO",
        "Llegada estimada | 11 de octubre de 2026",
      ].join("\n"),
    },
  },
  {
    ...
    description: "Hitos cumplidos, actual y pendientes",
    hint: "Prefijo «+» cumplido, «*» actual, sin prefijo pendiente.",
    defaults: {
      tone: "atencion",
      items: [
        "+ Zarpe | San Antonio",
        "* En tránsito | Señal recibida hoy",
        "Destino por confirmar | Verificación con la naviera",
        "Arribo | Fecha estimada",
      ].join("\n"),
    },
  },
  {
...
export const STUDIO_LIBRARY: StudioLibraryItem[] = [
  ...
  },
  {
    ...
    description: "Titular ámbar para algo que hay que verificar",
  ...
  },
  {
    ...
    description: "Titular teal para algo que salió bien",
    icon: "lucide:check-circle-2",
    props: {
      tone: "ok",
      kicker: "Confirmado",
      title: "La carga llegó a destino",
    },
  },
  {
    id: "compare-2",
    kind: "compare",
    label: "Contraste",
    description: "Antes → ahora, con el cambio destacado",
  ...
  },
  {
    ...
    kind: "factSheet",
    label: "Ficha de datos",
    description: "Etiqueta y valor, una fila por línea",
    icon: "lucide:table-2",
  },
  {
    id: "timeline",
    kind: "timeline",
    label: "Línea de tiempo",
    description: "Hitos con cumplido, actual y pendiente",
